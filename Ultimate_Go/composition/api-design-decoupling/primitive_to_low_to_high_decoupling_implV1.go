...
func store(s Storer, data []Data) (int,// All material is licensed under the Apache License Version 2.0, January 2004
...
// Explanation in Decoupling Part 3
